export const translations = {
  en: {
    ...
    githubStats: { title: 'Join Our Community', subtitle: 'Help us build the future of autonomous AI agents', stars: 'Stars', forks: 'Forks', issues: 'Issues', lastUpdate: 'Last Update', starUs: 'Star Us', discuss: 'Discuss', history: 'History' },
  ...
  zh: {
    ...
    githubStats: { title: '加入我们的社区', subtitle: '帮助我们构建自主 AI 的未来', stars: '星标', forks: '分支', issues: '问题', lastUpdate: '最后更新', starUs: '给我们星标', discuss: '讨论', history: '历史' },
  ...
  de: {
    ...
    githubStats: { title: 'Trete unserer Community bei', subtitle: 'Hilf uns, die Zukunft autonomer KI-Agenten zu bauen', stars: 'Sterne', forks: 'Forks', issues: 'Issues', lastUpdate: 'Letzte Aktualisierung', starUs: 'Stern geben', discuss: 'Diskutieren', history: 'Verlauf' },
  ...
  ja: {
    ...
    githubStats: { title: 'コミュニティに参加', subtitle: '自律型AIエージェントの未来を築くご協力をお願いします', stars: 'スター', forks: 'フォーク', issues: 'イシュー', lastUpdate: '最終更新', starUs: 'スターを付ける', discuss: '議論', history: '履歴' },
  ...
  ko: {
    ...
    githubStats: { title: '커뮤니티에 참여하세요', subtitle: '자율 AI 에이전트의 미래를 구축하는 것을 도와주세요', stars: '스타', forks: '포크', issues: '이슈', lastUpdate: '마지막 업데이트', starUs: '스타 주기', discuss: '논의하기', history: '기록' },
  ...
  'zh-TW': {
    ...
    githubStats: { title: '加入我們的社群', subtitle: '幫助我們構建自主 AI 的未來', stars: '星標', forks: '分支', issues: '問題', lastUpdate: '最後更新', starUs: '給我們星標', discuss: '討論', history: '歷史' },
  ...
  es: {
    ...
    githubStats: { title: 'Únete a Nuestra Comunidad', subtitle: 'Ayúdanos a construir el futuro de los agentes de IA autónomos', stars: 'Estrellas', forks: 'Forks', issues: 'Issues', lastUpdate: 'Última Actualización', starUs: 'Dános Estrella', discuss: 'Discutir', history: 'Historial' },
